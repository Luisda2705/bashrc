...
alias push='git add .; git status; git commit -m "update '#'curl "https://www.random.org/integers/?num=1&min=1&max=100&col=1&base=10&format=plain&rnd=new" "; git push;'
alias pull='git pull'
alias hak='echo https://$URL | hakrawler'
alias nab='naabu $URL'
alias urc='cp $HOME/.bashrc $HOME/bashrc/bashrc; cd $HOME/bashrc; push'
alias repos='git clone https://github.com/Luisda2705/bashrc.git && git clone https://github.com/Luisda2705/Tools.git; git clone https://github.com/Luisda2705/Init.git && git clone https://github.com/Luisda2705/Wordlist.git && git clone https://github.com/Luisda2705/Requests.git'
alias rmrepos='rm bashrc/ Tools/ Init/ Wordlist/ Requests/'
alias lnx='su lnx'
alias fz='fzf --preview "bat --color "always" {}" --exact --color fg:188,bg:233,hl:103,fg+:222,bg+:234,hl+:104 --color info:183,prompt:110,spinner:107,pointer:167,marker:215'
