...
alias nab='naabu $URL'
alias push='git add .; git status; git commit -m "$(date +"%T - %m/%d/%y" --date="6 hours ago")"; git push'
alias pushrc='cp $HOME/.bashrc $HOME/bashrc/bashrc; $HOME/bashrc; push; $HOME'
alias pushrp='$HOME; find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} add .; find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} status;find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} commit -m "$(date +"%T - %m/%d/%y" --date="6 hours ago")"; find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} push'
