...
alias addk='echo "deb http://http.kali.org/kali kali-rolling main contrib non-free non-free-firmware" | sudo tee /etc/apt/sources.list'
...
alias e='exit'
alias g='git clone'
alias dr='ssh root@146.190.154.65'
alias lg='ls -GF | rg'
