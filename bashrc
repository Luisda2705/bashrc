...
alias fz='fzf --preview "batcat --color "always" {}" -e --color fg:255,bg:000,hl:103,fg+:120,bg+:000,hl+:104 --color info:183,prompt:110,spinner:107,pointer:167,marker:215'
alias h='$HOME'
...
alias k='pr; rmrepos; repos; apt-get -y update && apt-get -y -f upgrade && apt-get -y -f full-upgrade && apt-get -y install kali-* && apt purge --autoremove -y;'
...
alias lx='su lx'
#alias fz='fzf --preview "batcat --color "always" {}" -e --color fg:255,bg:000,hl:103,fg+:100,bg+:000,hl+:104 --color info:183,prompt:110,spinner:107,pointer:167,marker:215'
