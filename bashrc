...
alias fz='fzf --preview "batcat --color "always" {}" -e --color fg:255,bg:000,hl:104,fg+:220,bg+:000,hl+:104 --color info:183,prompt:110,spinner:107,pointer:167,marker:215'
alias h='$HOME'
