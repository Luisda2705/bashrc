...
alias push='git add .; git status; git commit -m "update "#"""$(curl "https://www.random.org/integers/?num=1&min=1&max=10000&col=1&base=10&format=plain&rnd=new")"; git push;'
alias pull='git pull'
