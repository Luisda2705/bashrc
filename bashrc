...
alias pushall='$HOME; find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} add .; find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} status;find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} commit -m "$(date +"%T - %b/%d/%y" --date="6 hours ago")"; find . -maxdepth 2 -name .git -type d | rev | cut -c 6- | rev | xargs -I {} git -C {} push;'
alias pull='git pull'
alias hak='echo https://$URL | hakrawler'
alias nab='naabu $URL'
alias urc='cp $HOME/.bashrc $HOME/bashrc/bashrc; $HOME/bashrc'
alias push='urc && pushall'
